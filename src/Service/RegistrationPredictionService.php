 ...
 * No prediction logic in PHP; all data comes from scripts/predict_registrations.py.
 */
final class RegistrationPredictionService
{
    ...
    /**
     * Get next-month prediction and future inscriptions by type from Python script.
     *
    ...
    /**
     * Kept for backward compatibility: returns only next_month in the shape the template expected before.
     *
     * @param array<int, array{month:string, count:int|float|string}> $monthlyRegistrations
     *
