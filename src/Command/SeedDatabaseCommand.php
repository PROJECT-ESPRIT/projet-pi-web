...
class SeedDatabaseCommand extends Command
{
    ...
    private function createEvenements(SymfonyStyle $io, array $artists): array
    {
        ...
        $upcomingData = [
            ...
            ['Initiation à la Poterie',               'Apprenez à modeler l\'argile et créez vos premières œuvres en poterie. Un moment de détente et de créativité.',                                              'Maison des Arts, La Marsa',            20,  6, 14, 20.00, true,  38],
            ...
            ['Atelier Percussion Africaine',          'Découvrez les rythmes africains et apprenez à jouer du djembé et du balafon. Aucune expérience requise.',                                                  'Maison de la Culture, Sousse',         25,  8, 50, 20.00, true,   5],
