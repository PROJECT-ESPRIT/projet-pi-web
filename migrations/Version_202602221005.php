...
final class Version_202602221005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE donation (
            ...
            date_don DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\',
            INDEX IDX_JC94819C54C8C93 (type_id),
            INDEX IDX_JC94819C83A9843 (donateur_id),
            PRIMARY KEY(id)
