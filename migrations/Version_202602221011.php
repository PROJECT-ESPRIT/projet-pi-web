...
final class Version_202602221011 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'ForumReponse entity';
    }
    ...
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE forum_reponse (
            ...
            date_reponse DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\',
            INDEX IDX_280A49B629CCBAD0 (forum_id),
            INDEX IDX_280A49B66C759D3 (auteur_id),
            PRIMARY KEY(id)
